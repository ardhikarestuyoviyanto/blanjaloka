                        ...
                        <form action="{{ url('admin/pasar/edithandler') }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="no_pasar" placeholder="Nomor Pasar"
                                            required value="{{ $p->no_pasar }}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="custom-select" required name="id_pengelolapasar"
                                            id="id_pengelolapasar">
                                            <option selected value="">- PILIH PENGELOLA PASAR -</option>
                                            @foreach ($pengelola as $s)
                                                @if ($s->id_pengelolapasar == $p->id_pengelolapasar)
                                                    <option selected value="{{ $s->id_pengelolapasar }}">-
                                                        {{ $s->nama }} / {{ $s->jabatan }}</option>
                                                @elseif(count(DB::table('pasar')->where('id_pengelolapasar',
                                                    $s->id_pengelolapasar)->get()) == 0)
                                                    <option value="{{ $s->id_pengelolapasar }}">- {{ $s->nama }} /
                                                        {{ $s->jabatan }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="max_lapak"
                                            placeholder="Maksimal Lapak" required value="{{ $p->max_lapak }}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row control-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <input type="file" name="fotopasar[]" class="form-control filefoto"
                                                accept=".png,.jpg">
                                            ...
                                            @if ($p->foto_pasar != null)
                                                ...
                                                @for ($i = 0; $i < count($arr_fotopasar); $i++)
                                                    <li class="list-group-item">
                                                        <a title="Hapus" class="hapusfotopasar"
                                                        ...
                                                        &nbsp;&nbsp;
                                                        <a href="{{ url('assets/admin/foto_pasar/' . $arr_fotopasar[$i]) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.addfile').click(function() {
                ...
                html +=
                    '<input type="file" name="fotopasar[]" accept=".png,.jpg" class="form-control filefoto">';
